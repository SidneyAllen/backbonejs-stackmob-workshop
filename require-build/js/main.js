...
define("stackmob", ["jquery"], (function (global) {
    return function () {
        var ret, fn;
...
define('text!templates/wine/listTemplate.html',[],function () { return '<li>\n  <a href="#update/<%= wine_id %>"><%= winery %></a>\n</li>';});

define('views/wine/ListView',[
  'jquery',
  'underscore', 
  'backbone',
  'stackmob',
...
define('stackmobinit',['stackmob','underscore'], function(StackMob,_) {
...
define('collections/wine/WineCollection',[
  'stackmobinit',
  'models/wine/WineModel'
